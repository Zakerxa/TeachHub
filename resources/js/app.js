...
import { faCalendarCheck, faStreetView, faLocation, faBookOpen, faUser, faCircleCheck, faArrowLeftLong, faCalendarDays, faSliders, faMagnifyingGlass, faXmark, faHistory, faCheckCircle, faEyeSlash, faEye, faSearch, faBars, faAngleRight, faSignOut, faMobileScreen, faDesktop, faMapLocationDot, faAngleDown, faGlobe } from '@fortawesome/free-solid-svg-icons';
...
library.add(faCalendarCheck, faStreetView, faLocation, faBookOpen, faUser, faCircleCheck, faArrowLeftLong, faCalendarDays, faSliders, faMagnifyingGlass, faTwitter, faYoutube, faInstagram, faFacebook, faSquareTwitter, faSquareYoutube, faSquareInstagram, faXmark, faGlobe, faBars, faAngleDown, faAngleRight, faSignOut, faHistory, faCheckCircle, faEye, faEyeSlash, faSearch, faMapLocationDot, faMobileScreen, faDesktop);
/* create App for Vue */
